function loadComponentTabAccesso(){
    $.getJSON('http://sgiinteractivitylevel.azurewebsites.net/api/interactivitylevels',function(result){
    ...
    $.getJSON('http://sgiauth.azurewebsites.net/api/authentications',function(result){
        var figlio = [];
        $.each(result, function(i, field){
...
function loadComponentTabInfo(){
    $.getJSON('http://sgiserviceinputoutput.azurewebsites.net/api/serviceinputoutputs',function(result){
...
function loadComponentTabOrganizzazione(){
    $.getJSON('http://sgiroletype.azurewebsites.net/api/roles',function(result){
